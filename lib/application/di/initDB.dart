import 'package:math/data/local/repo/detail_notifi/local_notify_repo_impl.dart';
...
import '../../data/local/repo/pre_quiz/pre_pra_local_repo_impl.dart';
import '../../data/local/repo/pre_test/pre_test__local_repo.dart';
import '../../data/local/repo/pre_test/pre_test_local_repo_impl.dart';
import '../../data/local/repo/quiz_pra/quiz_pra_local_repo.dart';
import '../../data/local/repo/quiz_pra/quiz_pra_local_repo_impl.dart';
import '../../data/local/repo/test/quiz_test_local_repo.dart';
import '../../data/local/repo/test/quiz_test_local_repo_impl.dart';
...
void initDBandLocalRepo() {
  ...
  instance.registerLazySingleton<PrePraLocalRepo>(
      () => PrePraLocalRepoImpl(instance.get<AppDb>()));
  instance.registerLazySingleton<PlayerLocalRepo>(
      () => PlayerLocalRepoImpl(instance.get<AppDb>()));
  instance.registerLazySingleton<LocalNotifyRepo>(
      () => LocalNotifyRepoImpl(instance.get<AppDb>()));

...
class _IntroScreenState extends State<IntroScreen> {
  ...
  void initState() {
    ...
    listOnboard.add(
        Onboard("assets/images/intro1.png", titlePageIntro1, bodyPageIntro1));
    listOnboard.add(
        Onboard("assets/images/intro2.png", titlePageIntro2, bodyPageIntro2));
    listOnboard.add(
        Onboard("assets/images/intro3.png", titlePageIntro3, bodyPageIntro3));
    super.initState();
  }

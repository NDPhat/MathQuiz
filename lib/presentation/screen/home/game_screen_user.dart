...
class GameUserScreen extends StatefulWidget {
  GameUserScreen({Key? key}) : super(key: key);

  @override
  State<GameUserScreen> createState() => _GameUserScreenState();
}
                              ...
                              Column(
                                children: [
                                  RoundedButton(
                                    press: () {
                                      setState(() {
                                        if (clickingTesting == false) {
                                          setState(() {
                                            clickingTesting = true;
                                          });
                                        } else if (clickingTesting == true) {
                                          setState(() {
                                            clickingTesting = false;
                                          });
                                        }
                                      });
                                    },

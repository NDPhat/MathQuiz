                                      ...
                                      SizedBox(
                                        ...
                                        child: MyScrollDatePicker(
                                          ...
                                          onDateTimeChanged: (DateTime value) {
                                            context
                                                .read<AddNotifyCubit>()
                                                .dateTimeChange(formatDateInput
                                                    .format(value));
                                          },
                                          widthScreen: 80.w,
                                        ),
                            ...
                            var timePic = await showTimePicker(
                                ...
                                initialTime: TimeOfDay(
                                    ...
                                    minute: int.parse(state.timeStart
                                        .split(":")[1]
                                        .split(" ")[0])));
                            context.read<AddNotifyCubit>().emitStartTimeChange(
                                (timePic ??
                                        TimeOfDay(
                      ...
                      return BoxField(
                          ...
                          onTapped: () async {
                            ...
                            if (convertTimeDayToDouble(timePic ??
                              ...
                              context.read<AddNotifyCubit>().emitEndTimeChange(
                                  (TimeOfDay(
                                          hour: DateTime.now().hour,
                            ...
                            builder: (_) {
                              return SizedBox(
                                  ...
                                  child: BlocProvider.value(
                                      value: BlocProvider.of<AddNotifyCubit>(
                                          context),
